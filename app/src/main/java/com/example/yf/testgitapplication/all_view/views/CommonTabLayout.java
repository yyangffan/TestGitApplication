package com.example.yf.testgitapplication.all_view.views;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTextSelectSize=ta.getDimension(R.styleable.CommonTabLayout_tl_setextsize,sp2px(16f));
...
//            tv_tab_title.setPadding((int) mTabPadding, 0, (int) mTabPadding, 0);
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            if(isSelect) {
                ScaleAnimation scaleAnimation = new ScaleAnimation(1f, 1.05f, 1f, 1.05f,0.5f,0.5f);
                scaleAnimation.setDuration(400);
                tab_title.startAnimation(scaleAnimation);
            }
