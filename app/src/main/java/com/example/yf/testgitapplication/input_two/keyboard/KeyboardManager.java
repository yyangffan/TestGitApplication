package com.example.yf.testgitapplication.input_two.keyboard;
...
public class KeyboardManager {
    ...
    public KeyboardManager(Context context) {
        ...
        if (mContext instanceof Activity) {
            ...
            mKeyboardWithSearchView = (KeyboardWithSearchView) LayoutInflater.from(mContext).inflate(R.layout.layout_keyboard_viewtwo, null);
